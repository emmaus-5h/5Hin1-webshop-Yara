...
insert into products (name, description, code, price, model, productiejaar_id) values ('Lightning Bolt', 'Een zwarte hoesje met een bliksemschicht in het midden.', '445924201-X', 13.5, 'iPhone 11 ' , 2);
...
insert into products (name, description, code, price, model, productiejaar_id) values ('Special Honeycomb', 'Een coole gebroken zwarte hoesje om jouw onhandige kant te laten zien.', '492662523-7', 14, 'iPhone 11 ' , 1);
