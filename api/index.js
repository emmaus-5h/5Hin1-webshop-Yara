...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, products.model AS model, productiejaar_id AS productiejaar, kleuren_id  AS kleuren, rating_id AS rating FROM products ORDER BY products.name ASC')
